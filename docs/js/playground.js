;(function () {
  ...
  var pgViews = {
    ...
    dashboard: dv('Dashboard', '#132952, #0a1a3a', 520, 300,
    ...
    analytics: dv('Analytics', '#2a1845, #1a0d30', 520, 300,
    ...
    settings: dv('Settings', '#3a2510, #2a1808', 520, 300,
      ...
      '</div>'),
    revenue: dv('Revenue', '#0a3025, #082018', 440, 250,
    ...
    users: dv('User Stats', '#350a28, #25061a', 440, 250,
    ...
    metrics: dv('Deep Metrics', '#0d2e2e, #082020', 440, 250,
